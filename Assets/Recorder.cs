...
public class Recorder : MonoBehaviour
{
    ...
    void Start()
    {
        array = new float[30*60*10, 1+2*3+2*4]; // 10 minutes total. 8 just cuz -- i think can do 7 but
    ...
    private void GenerateObject(bool isLeft)
    {
        ...
        array[record_idx, 4] = objectPose.position.x;
        array[record_idx, 5] = objectPose.position.y;
        array[record_idx, 6] = objectPose.position.z;
